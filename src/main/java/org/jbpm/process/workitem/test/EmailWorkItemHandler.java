...
package org.jbpm.process.workitem.test;
 ...
 * 
 */
@Wid(widfile = "EmailDefinitions1.wid", name = "Email-New-1",
        displayName = "Email-New-1",
        defaultHandler = "mvel: new org.jbpm.process.workitem.test.EmailWorkItemHandler()",
